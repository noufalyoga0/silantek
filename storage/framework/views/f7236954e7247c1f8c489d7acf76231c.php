...
<nav class="navbar-silantek">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-sm px-3">
    ...
    <div class="container position-relative" style="z-index:1;">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn-hero-primary">
...
<section class="section-features">
    <div class="container">
        ...
        <div class="row g-3">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon, $bg, $color, $title, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-6 col-lg-4">
                <div class="feature-card">
                    <div class="feature-icon" style="background:<?php echo e($bg); ?>;">
                        <i class="bi <?php echo e($icon); ?>" style="color:<?php echo e($color); ?>;"></i>
                    </div>
                    <div class="feature-title"><?php echo e($title); ?></div>
                    <div class="feature-desc"><?php echo e($desc); ?></div>
                </div>
            </div>
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                <div class="d-flex flex-column gap-0">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$num, $bg, $color, $title, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex gap-3 align-items-start mb-4">
                        <div class="d-flex flex-column align-items-center">
                            <div style="width:40px; height:40px; background:<?php echo e($bg); ?>; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:0.9rem; color:<?php echo e($color); ?>; flex-shrink:0;">
                                <?php echo e($num); ?>

                            </div>
                            <?php if($num !== '4'): ?>
                            <div style="width:2px; height:40px; background:linear-gradient(to bottom, <?php echo e($color); ?>40, transparent); margin-top:4px;"></div>
                            <?php endif; ?>
                        </div>
                        <div class="pt-1">
                            <div class="fw-semibold mb-1" style="font-size:0.95rem;"><?php echo $title; ?></div>
                            <div class="text-muted" style="font-size:0.83rem; line-height:1.6;"><?php echo e($desc); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<section class="section-instansi">
    <div class="container text-center">
        ...
        <div class="d-flex flex-wrap justify-content-center gap-2">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nama): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="instansi-badge"><?php echo e($nama); ?></span>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
</section>
...
<section class="section-cta">
    <div class="container">
        <div style="max-width:560px; margin:0 auto;">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn-hero-primary" style="display:inline-block;">
...
<footer class="footer">
    <div class="container">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between gap-2">
            ...
            <div>
                &copy; <?php echo e(date('Y')); ?> Dinas Komunikasi dan Informatika Kabupaten Jombang
            </div>
        </div>
    </div>
</footer>
...
<?php /**PATH D:\Project New Kominfo - Copy\silantek\resources\views/welcome.blade.php ENDPATH**/ ?>