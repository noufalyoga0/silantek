    ...
    <header id="topbar">
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="d-none d-md-flex align-items-center gap-2 px-2 py-1 rounded-3"
                 style="background:<?php echo e($roleStyle[1]); ?>; border:1px solid <?php echo e($roleStyle[1]); ?>;">
                <i class="bi <?php echo e($roleStyle[3]); ?>" style="color:<?php echo e($roleStyle[2]); ?>; font-size:0.78rem;"></i>
                <span style="font-size:0.72rem; font-weight:600; color:<?php echo e($roleStyle[2]); ?>;">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li class="px-3 py-2">
                        ...
                        <span class="badge mt-1" style="background:<?php echo e($roleStyle[1]); ?>; color:<?php echo e($roleStyle[2]); ?>; font-size:0.68rem;">
                            <i class="bi <?php echo e($roleStyle[3]); ?> me-1"></i>
                            <?php echo e(match(auth()->user()->role) {
                                'admin'        => 'Administrator',
                                'csirt'        => 'Tim CSIRT',
                                'kabid_aptika' => 'Kabid APTIKA',
...
<?php /**PATH D:\Project New Kominfo\silantek\resources\views/layouts/app.blade.php ENDPATH**/ ?>