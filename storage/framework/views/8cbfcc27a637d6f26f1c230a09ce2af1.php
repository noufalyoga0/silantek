...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan | SILANTEK</title>
    ...
    <style>
        ...
        .error-icon { width:80px; height:80px; background:#dbeafe; border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 1.5rem; font-size:2rem; color:#2563eb; }
        .error-code { font-size:4rem; font-weight:700; color:#f1f5f9; line-height:1; margin-bottom:0.5rem; }
    </style>
</head>
<body>
    <div class="error-card">
        ...
        <h4 class="fw-bold mb-2" style="color:#0f172a;">Halaman Tidak Ditemukan</h4>
...
<?php /**PATH D:\Project New Kominfo - Copy\silantek\resources\views/errors/404.blade.php ENDPATH**/ ?>