<?php $__env->startSection('title', 'Dashboard Kabid APTIKA'); ?>
<?php $__env->startSection('page-title', 'Dashboard Kepala Bidang APTIKA'); ?>
    ...
    <div class="d-flex align-items-center justify-content-between" style="position:relative; z-index:1;">
        ...
        <div class="d-none d-md-flex gap-2">
            <div class="text-center px-3 py-2 rounded-3"
                ...
                <div class="fw-bold text-white" style="font-size:1.25rem;"><?php echo e($stats['total_bulan_ini']); ?></div>
                <div style="font-size:0.65rem; color:rgba(255,255,255,.55);">Insiden bulan ini</div>
            </div>
            <div class="text-center px-3 py-2 rounded-3"
                 style="background:<?php echo e($stats['overdue'] > 0 ? 'rgba(239,68,68,.2)' : 'rgba(255,255,255,.08)'); ?>;
                        border:1px solid <?php echo e($stats['overdue'] > 0 ? 'rgba(239,68,68,.4)' : 'rgba(255,255,255,.12)'); ?>;
                        min-width:80px;">
                <div class="fw-bold <?php echo e($stats['overdue'] > 0 ? 'overdue-badge' : ''); ?>"
                     style="font-size:1.25rem; color:<?php echo e($stats['overdue'] > 0 ? '#f87171' : '#fff'); ?>;">
                    <?php echo e($stats['overdue']); ?>

                </div>
                <div style="font-size:0.65rem; color:<?php echo e($stats['overdue'] > 0 ? 'rgba(248,113,113,.8)' : 'rgba(255,255,255,.55)'); ?>;">
                    Overdue
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm h-100 text-center"
            ...
            <div class="card-body p-4 pt-4">
                ...
                <div style="font-size:2.25rem; font-weight:800; color:#0f172a; line-height:1;">
                    <?php echo e($stats['total_bulan_ini']); ?>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100 text-center"
             style="border-radius:14px !important; overflow:hidden;
                    ...
                    <?php echo e($stats['overdue'] > 0 ? 'background:linear-gradient(180deg,#fff1f2,#fff);' : ''); ?>">
            <div class="card-body p-4 pt-4">
                <div style="width:52px; height:52px; border-radius:14px;
                    ...
                    <i class="bi bi-exclamation-triangle-fill <?php echo e($stats['overdue'] > 0 ? 'overdue-badge' : ''); ?>"
                       style="color:<?php echo e($stats['overdue'] > 0 ? '#dc2626' : '#94a3b8'); ?>; font-size:1.4rem;"></i>
                </div>
        ...
        <div class="card border-0 shadow-sm h-100 text-center"
            ...
            <div class="card-body p-4 pt-4">
                ...
                <div style="font-size:1.85rem; font-weight:800; color:#0f172a; line-height:1;">
                    <?php if($jRata > 0): ?><?php echo e($jRata); ?>j <?php endif; ?><?php echo e($mRata); ?>m
                </div>
...
<div class="card border-0 shadow-sm" style="border-radius:14px !important; overflow:hidden;">
    <div class="card-header py-3"
         style="<?php echo e($tiketOverdue->count() > 0 ? 'background:#fff1f2 !important;' : ''); ?>">
        <h6 class="mb-0 fw-semibold <?php echo e($tiketOverdue->count() > 0 ? 'text-danger' : 'text-success'); ?>">
            <?php if($tiketOverdue->count() > 0): ?>
                <i class="bi bi-exclamation-triangle-fill me-2"></i>
                Tiket OVERDUE — Perlu Eskalasi (<?php echo e($tiketOverdue->count()); ?>)
            <?php else: ?>
    ...
    <div class="card-body p-0">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $tiketOverdue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="overdue-row">
                        ...
                        <td class="small text-danger">
                            <?php if($t->sla_deadline): ?> <?php echo e($t->sla_deadline->diffForHumans()); ?> <?php endif; ?>
                        </td>
                        <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project New Kominfo - Copy\silantek\resources\views/dashboard/kabid.blade.php ENDPATH**/ ?>