...
<head>
    <meta charset="UTF-8">
    <title>Laporan Insiden Keamanan TIK — <?php echo e($namaBulan); ?> <?php echo e($tahun); ?></title>
    <style>
...
<div class="footer-doc">
    ...
    Dicetak: <?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?> pukul <?php echo e(now()->format('H:i:s')); ?> WIB &nbsp;|&nbsp;
...
<div class="judul-laporan">
    ...
    <p>Periode: <?php echo e($namaBulan); ?> <?php echo e($tahun); ?> &nbsp;·&nbsp; Bidang Aplikasi Telekomunikasi dan Informatika (APTIKA)</p>
    <div class="nomor-laporan">
        No. Laporan: <?php echo e(str_pad($tiket->count(), 3, '0', STR_PAD_LEFT)); ?>/SILANTEK/APTIKA/<?php echo e(strtoupper(substr($namaBulan, 0, 3))); ?>/<?php echo e($tahun); ?>
...
<div class="ringkasan">
    <div class="ringkasan-cell">
        <span class="ringkasan-num c-blue"><?php echo e($stats['total']); ?></span>
        <span class="ringkasan-label">Total Insiden</span>
    </div>
    <div class="ringkasan-cell">
        <span class="ringkasan-num c-yellow"><?php echo e($stats['open']); ?></span>
        <span class="ringkasan-label">Belum Selesai</span>
    </div>
    <div class="ringkasan-cell">
        <span class="ringkasan-num c-green"><?php echo e($stats['resolved']); ?></span>
        <span class="ringkasan-label">Selesai Ditangani</span>
    </div>
    <div class="ringkasan-cell">
        <span class="ringkasan-num c-red"><?php echo e($stats['overdue']); ?></span>
        <span class="ringkasan-label">Melewati SLA</span>
    </div>
    <div class="ringkasan-cell">
        <span class="ringkasan-num c-purple"><?php echo e($stats['rata_rata_jam']); ?>j</span>
        <span class="ringkasan-label">Rata-rata Penanganan</span>
    </div>
</div>


<div class="section-title">II. Detail Insiden Periode <?php echo e($namaBulan); ?> <?php echo e($tahun); ?></div>
<table class="data-tabel">
    ...
    <tbody>
        ...
        <tr class="<?php echo e($t->is_overdue ? 'overdue-row' : ''); ?>">
            <td style="text-align:center; color:#94a3b8;"><?php echo e($i + 1); ?></td>
            <td>
                <strong><?php echo e($t->nomor_tiket); ?></strong>
                <?php if($t->is_overdue): ?>
            ...
            <td>
                <?php echo e($t->nama_pelapor); ?><br>
                <span style="color:#94a3b8; font-size:7px;"><?php echo e($t->nip_pelapor); ?></span>
            </td>
            <td><?php echo e($t->kategoriInsiden->nama ?? '-'); ?></td>
            <td><span class="badge badge-<?php echo e($t->slaConfig->urgensi ?? 'secondary'); ?>"><?php echo e(ucfirst($t->slaConfig->urgensi ?? '-')); ?></span></td>
            <td><span class="badge badge-<?php echo e($t->status); ?>"><?php echo e($t->status_label); ?></span></td>
            <td style="text-align:center;"><?php echo e($t->slaConfig->durasi_jam ?? '-'); ?>j</td>
            <td><?php echo e($t->created_at->format('d/m/Y')); ?><br><span style="color:#94a3b8;"><?php echo e($t->created_at->format('H:i:s')); ?></span></td>
            <td>
                <?php if($t->resolved_at): ?>
                    <?php echo e($t->resolved_at->format('d/m/Y')); ?><br>
                    <span style="color:#94a3b8;"><?php echo e($t->resolved_at->format('H:i:s')); ?></span>
                <?php else: ?>
            ...
            <td style="text-align:center;">
                <?php if($t->resolved_at): ?>
                    ...
                    ?>
                    <?php if($jamDur > 0): ?><?php echo e($jamDur); ?>j <?php endif; ?><?php echo e($menitDur); ?>m
                <?php else: ?>
                    -
                <?php endif; ?>
            </td>
...
<p style="font-size:8px; color:#475569; line-height:1.6; margin-bottom:16px;">
    ...
    Pemerintah Kabupaten Jombang periode <?php echo e($namaBulan); ?> <?php echo e($tahun); ?>.
...
<div class="ttd-section">
    ...
    <div class="ttd-cell">
        <div class="ttd-box right">
            <div class="ttd-title">Jombang, <?php echo e(now()->locale('id')->isoFormat('D MMMM YYYY')); ?></div>
...
<?php /**PATH D:\Project New Kominfo - Copy\silantek\resources\views/laporan/pdf.blade.php ENDPATH**/ ?>