    ...
    <div class="col-lg-8">
        ...
        <div class="card border-0 shadow-sm mb-3" style="overflow:hidden;">
            ...
            <div style="background:{{ $grad }}; padding:1rem 1.25rem;">
                ...
                @if($tiket->sudahDioverride())
                <div class="mt-1" style="font-size:0.7rem; color:rgba(255,255,255,0.65);">
                    <i class="bi bi-info-circle me-1"></i>
                    Urgensi diverifikasi Tim CSIRT saat Triase
                    @if($tiket->catatan_triase) · "{{ $tiket->catatan_triase }}" @endif
                </div>
