...
<head>
    ...
    <title>@yield('title', 'SILANTEK') — Diskominfo Kab. Jombang</title>
...
<aside id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('tiket.create') }}"
           class="nav-item-link {{ request()->routeIs('tiket.create') ? 'active' : '' }}">
        ...
        <a href="{{ route('tiket.index') }}"
           class="nav-item-link {{ request()->routeIs('tiket.index','tiket.show') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.opd.index') }}"
           class="nav-item-link {{ request()->routeIs('admin.opd.*') ? 'active' : '' }}">
            <span class="nav-icon"><i class="bi bi-buildings"></i></span>
            Kelola OPD
        </a>
        <a href="{{ route('admin.user.index') }}"
           class="nav-item-link {{ request()->routeIs('admin.user.*') ? 'active' : '' }}">
            <span class="nav-icon"><i class="bi bi-people"></i></span>
            Kelola User
        </a>
        <a href="{{ route('admin.kategori.index') }}"
           class="nav-item-link {{ request()->routeIs('admin.kategori.*') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        <a href="{{ route('profil') }}" class="d-flex align-items-center gap-2 text-decoration-none"
...
<div id="main-content" style="min-height:100vh;">
    ...
    <header id="topbar">
        ...
        <div class="topbar-right">
            ...
            {{-- Notifikasi --}}
            <a href="{{ route('notifikasi') }}" class="notif-btn">
            ...
            <div class="dropdown">
                <div class="topbar-user-btn" data-bs-toggle="dropdown" role="button">
                    ...
                    <span class="d-none d-md-inline">{{ Str::limit(auth()->user()->nama, 18) }}</span>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li class="px-3 py-2">
                        <div class="d-flex align-items-center gap-2 mb-1">
                            ...
                            <div>
                                <div class="fw-semibold" style="font-size:0.82rem;">{{ auth()->user()->nama }}</div>
